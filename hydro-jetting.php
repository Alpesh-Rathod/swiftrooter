            ...
            <div class="services__details-content">
                <div class="section__header">
                    <div class="services__main-images">
                        <img src="assets/images/services/services-man-15.jpg" alt="services man" />
                    </div>
                    <span class="sub-title">
                        ...
                        </svg>Hydro Jetting </span>
                    <h2 class="main-title"> Hydro Jetting – Clear Your Drains Fast & Efficiently
                    </h2>
                    <p class="desc">Our hydro jetting services use high-pressure water to clear blockages in your drains and pipes. This method is highly effective for removing grease, mineral deposits, and other buildup that can cause clogs, ensuring your plumbing system functions smoothly.</p>
                </div>
