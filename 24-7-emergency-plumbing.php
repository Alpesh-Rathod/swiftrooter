            ...
            <div class="services__details-content">
                ...
                <div class="section__header">
                    <div class="services__main-images">
                        <img src="assets/images/services/services-man-1.jpg" alt="services man" />
                    </div>
                    <span class="sub-title">
                        ...
                        </svg>24/7 Emergency Plumbing</span>
                    <h2 class="main-title">24/7 Emergency Plumber – Fast & Reliable Service</h2>
                    <p class="desc">Plumbing emergencies can happen anytime, and when they do, you need a trusted
                        professional to fix the issue quickly. At QnixRooter Plumbing, we offer 24/7 emergency
                        plumbing services to handle leaks, burst pipes, clogs, and other urgent plumbing issues. Our
                        expert plumbers are always ready to provide fast, efficient, and professional solutions.</p>
                </div>
