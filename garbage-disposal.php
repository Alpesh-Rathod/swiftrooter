            ...
            <div class="services__details-content">
                <div class="section__header">
                    <div class="services__main-images">
                        <img src="assets/images/services/services-man-7.jpg" alt="services man" />
                    </div>
                    <span class="sub-title">
                        ...
                        </svg>Garbage Disposal</span>
                    <h2 class="main-title">Garbage Disposal Installation & Repair – Professional Service
                    </h2>
                    <p class="desc">Professional garbage disposal installation and repair services to keep your kitchen appliances running smoothly. Our experts handle all types of garbage disposals, from installation to maintenance and replacement, ensuring efficient waste processing and preventing clogs.</p>
                </div>
