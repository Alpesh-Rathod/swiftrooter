...
<section class="services__details-section">
    <div class="auto-container">
        <div class="back__topage">
        ...
        <div class="services__details-grid hero__banner--section" data-aos="fade-up" data-aos-duration="1000">
            <div class="services__details-content">
                <div class="section__header">
                    <div class="services__main-images">
                        <img src="assets/images/services/services-man-3.jpg" alt="services man" />
                    </div>
                    <span class="sub-title">
                        ...
                        </svg>Water Heaters</span>
                    <h2 class="main-title">Water Heater Installation & Repair – Reliable Hot Water Solutions</h2>
                    <p class="desc">A faulty water heater can disrupt daily activities. We specialize in installing, repairing, and maintaining gas, electric, and tankless water heaters to provide energy-efficient and reliable hot water for your home or business. Whether your water heater is leaking, not heating properly, or needs a full replacement, our experts will ensure a seamless solution that meets your needs and budget.</p>
                </div>
                <div class="emergency__contact">
                    <div class="contact__top-sec">
                        <div class="contact__icon-box">
                            <img src="assets/images/contact-call.png">
                        </div>
                        <div class="contact__text-box">
                            <p>Emergency Contact</p>
                            <h4>+1 [303] 873-2983</h4>
                        </div>
                    </div>
                    <div class="call-btn">
                        <a href="callto:+1 [303] 873-2983" class="btn">Call Now</a>
                    </div>
                    <div class="contact__top-sec mt-20">
                        <div class="contact__icon-box">
                            <img src="assets/images/contact-email.png">
                        </div>
                        <div class="contact__text-box">
                            <p>Emergency Email</p>
                            <h4>hello@Qnixrooter.com</h4>
                        </div>
                    </div>
                    <div class="call-btn">
                        <a href="mailto:hello@Qnixrooter.com" class="btn">Email Now</a>
                    </div>
            ...
            <div class="form__container">
                <form id="contactForm" class="contactform">
                    ...
                    <p class="contact-form__disclaimer">
                        By submitting your contact details, you agree to receive automated SMS/MMS messages from
                        QnixRooter
        ...
        <div class="why__choose--grid">
            <div class="section__header">
                ...
                <div class="video-container">
                    <video id="videoPlayer">
                        <source src="assets/images/services/JlxORnim9G3MFRZcSpQmqWHVNOY.mp4"
                            type="video/mp4">
            ...
            <div class="why__choose-card-box">
                <div class="choose__item">
                    ...
                    <p class="paragraph">We understand that plumbing emergencies can't wait. Our team is available
                        24/7 to ensure that your issues are resolved quickly, minimizing damage and inconvenience.
                    </p>
                </div>
