            ...
            <div class="services__details-content">
                <div class="section__header">
                    <div class="services__main-images">
                        <img src="assets/images/services/services-man-8.jpg" alt="services man" />
                    </div>
                    ...
                    <h2 class="main-title"> Repiping – Upgrade Old or Damaged Pipes
                    </h2>
                    <p class="desc">Professional repiping services to upgrade old or damaged pipes in your home. Our experts handle all types of repiping, from copper to PEX, ensuring efficient water flow and preventing future issues.</p>
                </div>
