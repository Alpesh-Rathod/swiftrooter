            ...
            <div class="services__details-content">
                <div class="section__header">
                    <div class="services__main-images">
                        <img src="assets/images/services/services-man-12.jpg" alt="services man" />
                    </div>
                    <span class="sub-title">
                        ...
                        </svg>Pipe & Fixtures </span>
                    <h2 class="main-title"> Pipe & Fixture Installation – High-Quality Plumbing Solutions
                    </h2>
                    <p class="desc">Our pipe and fixture installation services ensure your plumbing system is built to last. We provide expert installation of pipes, fixtures, and related components for residential and commercial properties, using high-quality materials and industry best practices.</p>
                </div>
