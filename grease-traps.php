            ...
            <div class="services__details-content">
                <div class="section__header">
                    <div class="services__main-images">
                        <img src="assets/images/services/services-man-10.jpg" alt="services man" />
                    </div>
                    <span class="sub-title">
                        ...
                        </svg>Grease Traps </span>
                    <h2 class="main-title"> Professional Drain Cleaning – Remove Clogs & Restore Flow
                    </h2>
                    <p class="desc">Blocked drains can lead to slow water drainage, bad odors, and even pipe damage. Our professional drain cleaning services use advanced tools to remove grease, debris, and buildup, ensuring smooth water flow and preventing costly future repairs.</p>
                </div>
